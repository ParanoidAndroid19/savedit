...
// for using the build files in server/public instead of the client stuff
...
app.post('/reddit/getRedditAccessToken', (req, res) => {
  ...
  const redditClientId = process.env.REACT_APP_clientId
  const redditClientSecret = process.env.REACT_APP_clientSecret
